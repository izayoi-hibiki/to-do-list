...
//         console.log( orientation + "是orientation的值");
//         // return false;
...
function orientation() {
    ...
    var page_h = document.documentElement.clientHeight;
    if (page_h > page_w) {//竖屏
        $(".clear").removeClass("clear-landscape");
        $(".clear").addClass("clear-portrait");
        $(".finish").removeClass("finish-landscape");
        $(".finish").addClass("finish-portrait");
        $(".createdTime").css("right","52px");
    } else {//横屏
        $(".clear").removeClass("clear-portrait");
        $(".clear").addClass("clear-landscape");
        $(".finish").removeClass("finish-portrait");
        $(".finish").addClass("finish-landscape");
        $(".createdTime").css("right","12px");
